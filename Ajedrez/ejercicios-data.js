const listaEjercicios = [
  ...
  },
  {
    ...
    solucion: [
      ...
      },
      {
        jugada: "Nd5",
        esMia: false,
        explicacionBien: "Nd5 es la reacción crítica del caballo f6 ante el avance e5 y busca un puesto central activo.",
        explicacionMal: "Una respuesta defensiva distinta puede cambiar la posición; el objetivo es calcular esta defensa crítica y continuar con precisión."
      },
      {
        jugada: "Nxd5",
  ...
  },
  {
    ...
    solucion: [
      ...
      },
      {
        jugada: "Nxe5",
        esMia: false,
        explicacionBien: "Nxe4 es la reacción táctica crítica: el caballo captura el peón central después de la ruptura e5.",
      ...
      },
      {
        jugada: "Nxe5",
        esMia: true,
        explicacionBien: "Nxe5 recaptura el caballo y demuestra que la ruptura e5 puede convertir la ventaja espacial en una ganancia concreta de material.",
        explicacionMal: "No recapturar permite que las negras conserven el caballo que capturó el peón avanzado."
      }
    ]
  },
  {
    ...
    fen: "r1bq1rk1/ppp2ppp/2n2n2/8/3P4/3BP1N1/PP2Q1PP/R3K2R w KQ - 0 9",
  ...
  },
  {
    ...
    fen: "r2q1rk1/ppp2ppp/2n1pn2/3p2B1/3PP3/2N2N2/PP3PPP/R2QK2R w KQ - 0 9",
  ...
  },
  {
    ...
    fen: "r1bq1rk1/ppp2ppp/2n2n2/8/3P4/2NB4/PP3PPP/R2QK2R w KQ - 0 9",
    ...
    solucion: [
      ...
      },
      {
        jugada: "Qg4+",
        esMia: true,
        explicacionBien: "Qg4+ lleva la dama a la diagonal de ataque y mantiene al rey negro bajo jaque.",
        explicacionMal: "Una jugada sin jaque permite al rey reorganizarse y reduce la compensación del sacrificio."
      }
    ]
  },
  ...
  },
  {
    ...
    categoria: "Defensa Holandesa",
    titulo: "Ataque en el flanco de rey",
    fen: "r1bq1rk1/ppp3pp/2n2p2/3p1p2/3P4/2N1P3/PP3PPP/R1BQ1RK1 w - - 0 9",
  ...
  },
  {
    ...
    fen: "r1bq1rk1/ppp2ppp/3ppn2/5p2/2PP4/5NP1/PP2PPBP/RNBQ1RK1 w - - 0 8",
  ...
  },
  {
    ...
    solucion: [
      ...
      },
      {
        jugada: "Nf6",
        esMia: false,
        explicacionBien: "Nf6 desarrolla una pieza y representa una respuesta natural del negro antes de que el centro se abra.",
        explicacionMal: "Permitir d4 sin atender al desarrollo facilita que las blancas abran el centro con mayor iniciativa."
      },
      {
        jugada: "d4",
        esMia: true,
...
const EXERCISE_DATABASE = {
  schemaVersion: "2.0.0",
  sourceFormat: "flat-array",
  themes: (() => {
    const groups = new Map();

    for (const exercise of listaEjercicios) {
      const category = exercise.categoria || "Sin categoría";
      ...
      groups.get(category).exercises.push(exercise);
    }
...
function getExerciseById(id) {
  return listaEjercicios.find(
    exercise => exercise.id === id
  ) || null;
}

function getThemeById(id) {
  return EXERCISE_DATABASE.themes.find(
    theme => theme.id === id
  ) || null;
}

window.listaEjercicios = listaEjercicios;
